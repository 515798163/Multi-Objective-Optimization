...
SOURCE_TARGET_PATH = '../data/Slashdot.csv'
MATRIX_PATH = '../data/Slashdot_matrix.csv'
SHORTEST_PATH = '../data/Slashdot_shortest_path.csv'
...
def assemble_feature():
    ...
    pd.DataFrame(features).to_csv(FEATURES_PATH, header=True, index=False)
