...
# r_sources_dataset = np.asarray(pd.read_csv("../data/facebook/r_sources.csv")).tolist()
...
class SocialNetwork:
    ...
    def random_rumor_sources(self):
        ...
        # r_sources = random.sample(range(NODE_NUMBER), RUMOR_NUMBER) #随机抽取

        # rumor_dataset = r_sources_dataset
        # r_sources = random.choice(rumor_dataset)
